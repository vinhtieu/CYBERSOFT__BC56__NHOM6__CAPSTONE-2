...
class Product {
  static render = (array) => {
    constant.productGrid.innerHTML = this.getHTML(array);
  };

  static getHTML = (array) => {
    let html = array.map((product) => {
      `
        <div class="h-[32.625rem] min-[40.5rem]:h-[33.875rem] rounded bg-gray-50 dark:bg-gray-800" onclick="openProductOverview(${product.id})">
          <div class="w-full h-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <a href="#">
              <h5
                class="text-2xl font-semibold tracking-tight text-gray-900 sm:text-xl dark:text-white">
                ${product.name}
              </h5>
            </a>
            ...
            //#endregion
                ...
                //#region Rating Stars
              <div class="flex items-center mt-4 mb-6 sm:mt-3 sm:mb-5">
                <svg
              ...
              //#endregion
                ...
                //#region Price
                   ...
                   <div class="flex items-center justify-between">
                     <span
                       class="text-2xl font-bold text-gray-900 sm:text-xl dark:text-white"
                       >27.000.000đ</span
                     >
                   </div>
